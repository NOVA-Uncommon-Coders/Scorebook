...
public class GameController {
   ...
   static Pitcher currentPitcher = new Pitcher("yamama");
   ...
   static Batter currentBatter = new Batter("Mike");
        ...
        if(countText.equals("balls")) {
            ...
            if(countText.equals("strikes")){
                if(currentBatter.getBatterCount().getStrike() < 2){
                    currentBatter.getBatterCount().setStrike(currentBatter.getBatterCount().getStrike() + 1);
                }
            }
        }
        return "redirect:/home";
